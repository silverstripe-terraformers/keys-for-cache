 ...
 */
class DotNotationCaredBelongsTo extends DataObject implements TestOnly
{
    ...
    private static array $belongs_to = [
        'CaresPageFirst' => DotNotationCaresPage::class . '.CaredBelongsToFirst',
        'CaresPageSecond' => DotNotationCaresPage::class . '.CaredBelongsToSecond',
    ];
    ...
    private static string $table_name = 'DotNotationCaredBelongsTo';
