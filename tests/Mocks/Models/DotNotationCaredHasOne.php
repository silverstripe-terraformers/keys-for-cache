 ...
 */
class DotNotationCaredHasOne extends DataObject implements TestOnly
{
    ...
    private static array $has_many = [
        'CaresPagesFirst' => DotNotationCaresPage::class . '.CaredHasOneFirst',
        'CaresPagesSecond' => DotNotationCaresPage::class . '.CaredHasOneSecond',
    ];
    ...
    private static string $table_name = 'DotNotationCaredHasOne';
