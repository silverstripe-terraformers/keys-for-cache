 ...
 */
class DotNotationTouchedHasOne extends DataObject implements TestOnly
{
    ...
    private static array $has_many = [
        'TouchesPagesFirst' => DotNotationTouchesPage::class . '.TouchedHasOneFirst',
        'TouchesPagesSecond' => DotNotationTouchesPage::class . '.TouchedHasOneFirst',
    ];
    ...
    private static string $table_name = 'DotNotationTouchedHasOne';
